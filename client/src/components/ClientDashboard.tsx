    ...
    return (
        ...
        >
            <div className="max-w-7xl mx-auto space-y-8">
                ...
                {/* Pending Review */}
                <div className="mb-8">
                    <h2 className="text-2xl font-bold text-white mb-4">👀 Pending Your Review</h2>
                    <div className="grid gap-4">
                        {completedJobs.map((job) => (
                            <div key={job.id} className="dark-card rounded-xl shadow-xl p-6 border-2 border-yellow-700/50">
                                <div className="flex justify-between items-start mb-4">
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-900">{job.description}</h3>
                                        <p className="text-sm text-yellow-600 font-medium">⏳ Freelancer marked as completed</p>
                                    </div>
                                    <div className="text-right">
                                ...
                                <div className="border-t border-purple-950/50 pt-4">
                                    ...
                                    <div className="bg-black/70 rounded-lg p-4 border border-purple-950/50">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full px-4 py-2 bg-gray-800/50 border border-purple-950/70 text-white rounded-lg mb-3 focus:ring-2 focus:ring-red-500 focus:border-transparent placeholder-gray-500"
                                            rows={3}
                                        />
                                        <button
                                            ...
                                            <div className="bg-black/70 rounded-lg p-4 border border-purple-950/50">
                                                ...
                                                {dispute.status === 'RESOLVED' && (
                                                    <p className="text-sm font-bold text-green-600 mt-2">
                                                        ✅ Resolved in favor of: {dispute.winner}
                                                    </p>
                                                )}
                                            </div>
                                        )}
                ...
                {approvedJobs.length > 0 && (
                    <div className="mb-8">
                        <h2 className="text-2xl font-bold text-gray-900 mb-4">✅ Completed Projects</h2>
                        <div className="grid gap-4">

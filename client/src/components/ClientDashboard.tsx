...
export default function ClientDashboard() {
    ...
    return (
        <div className="bg-gradient-to-br from-blue-50 to-cyan-100 min-h-full p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600">Manage your projects and payments</p>
                        </div>
                ...
                {/* Pending Review */}
                <div className="mb-8">
                    <h2 className="text-2xl font-bold text-gray-900 mb-4">👀 Pending Your Review</h2>
                    <div className="grid gap-4">
                        {completedJobs.map((job) => (
                            <div key={job.id} className="bg-white rounded-xl shadow-lg p-6 border-2 border-yellow-200">
